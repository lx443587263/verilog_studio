...
/**********************************************/
void VerilogStudio::Module::AddBracketsLocation(int location) {
    BracketsLocation = location;
}

/**********************************************/
void VerilogStudio::Module::AddEndBracketsLocation(int location) {
    EndBracketsLocation = location;
}

/**********************************************/
int VerilogStudio::Module::GetBracketsLocation() {
    return BracketsLocation;
}

/**********************************************/
int VerilogStudio::Module::GetEndBracketsLocation() {
    return EndBracketsLocation;
}

/**********************************************/
void VerilogStudio::Module::AddPortActualLocation(int location) {
    PortActualLocation = location;
}

/**********************************************/
int VerilogStudio::Module::GetPortActualLocation() {
    return PortActualLocation;
}
